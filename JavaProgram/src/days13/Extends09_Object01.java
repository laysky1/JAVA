...
// 자바 내부에 존재하는 그리고 새롭게 만들어지는 모든 클래스는 보이진 않는 곳에 extends Object가 존재합니다.
// 자바 내부에 존재하는 그리고 새롭게 만들어지는 모든 클래스의 부모클래스 입니다.
// 자바의 클래스는 한 클래스당 하나의 부모클래스만 가질 수 있습니다.
// Object 아닌 다른 클래스를 상속하면 그 클래스는 extends Object가 지워집니다.
// 이렇게 extends Object가 없는 경우는 그 부모 클래스가 이미 Object를 상속하고 있기 때문에
...
public class Extends09_Object01 {
	...
	public static void main(String[] args) {
		...
		//getClass 메소드는 해당 객체의 클래스 이름을 리턴해주는 메서드이며, Object 클래스에서 상속받은 메서드입니다.
		...
		//toString 메소드는 해당객체의 정보를 문자열로 리턴해주는 메서드
		System.out.println(obj.toString());
		System.out.println(obj);
		// .toString()은 생략해도 같은 출력이 이루어 집니다.
		// 패키지 이름. 클래스이름@해시코드
		...
		// 그래서 "패키지이름.클래스이름@해시코드"이 아닌 저장된 문자열이 출력됩니다.
